...
if __name__ == "__main__":
    ...
    model_name = STHDformer.__name__
    
    pattern_matrix = load_matrix(data_path + "/traffic_pattern_matrix.pkl")
    pattern_matrix = torch.FloatTensor(pattern_matrix)
    
    semantic_matrix = load_matrix(data_path + "/spatial_semantics_matrix.pkl")
    semantic_matrix = torch.FloatTensor(semantic_matrix)
    ...
    # -------------------------------- load model -------------------------------- #
    model = STHDformer(**cfg["model_args"], pattern_matrix=pattern_matrix, transition_matrix=transition_matrix, semantic_matrix=semantic_matrix).to(DEVICE)
